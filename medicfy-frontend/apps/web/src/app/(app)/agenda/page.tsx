...
function AgendaList({ accessToken }: { accessToken: string }) {
  ...
  const today = new Intl.DateTimeFormat("es-MX", { timeZone: MX_TIME_ZONE, day: "numeric", month: "long", year: "numeric" }).format(new Date());

  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-6 p-6">
      <div>
        <h1 className="font-heading text-2xl text-brand-900">Agenda del día</h1>
